...
fp31!(
    ...
    //
    // sage: mont_r = 2^496
    // sage: mont_r_inv = 204586912993508866875824356051724947013540127877691549342705710506008362275292159680204380770369009821930417757972504438076078534117837065833032974336^-1 % p
    // sage: mont_r_inv.digits(2^31)
    [
        1425137694, 1731309518, 1953497209, 816778308, 2098285829, 2101532596, 1244700937,
        284479382, 1822066254, 750610203, 2046151087, 1028879015, 982185822, 713481984, 365859767,
        8686
    ],
    // montgomery R^2 mod p
    // sage: mont_r_squared = mont_r^2 % p
    // sage: mont_r_squared.digits(2^31)
    [
        528441285, 753555649, 1122396277, 447256011, 1044659882, 601268910, 1288393588, 1300071698,
        459760048, 1589790375, 679948246, 668907438, 554462650, 790762110, 130475831, 10835
    ],
    // -p[0]^-1
